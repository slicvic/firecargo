...
<head>
    ...
    <link href="/assets/crm/css/guest/justified-nav.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/assets/crm/css/guest/main.css">
    <script src="/assets/crm/js/guest.js"></script>
    ...
    <div class="container">
        <div class="masthead">
            <div class="user-nav text-right">
                <?php if (Auth::check()): ?>
                    <?php echo Lang::get('messages.welcome') . ' <b>' . $user->name() . ' (' . $user->cid() . ')'; ?></b>
                    <?php if ( ! $user->isAdmin()): ?>
                        <a href="/user/dashboard" class="btn btn-info"><i class="fa fa-home"></i> Mi Casillero</a>
                        <a href="/user/profile" class="btn btn-info"><i class="fa fa-user"></i> Perfil</a>
                    <?php endif; ?>
                    <a href="/logout" class="btn btn-info"><i class="fa fa-sign-out"></i> Cerrar Sesion</a>
                <?php else: ?>
