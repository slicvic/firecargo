...
<table border="0">
    <tr>
        ...
        <td><br><br><h2>Sticker # {{ $stickerNumber }} / {{ $totalPackages }}</h2></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            {{ ($country = $consignee->country) ? strtoupper($country->name) : '' }}
        </td>
    </tr>
</table>
...
<table>
    <tr>
        ...
        <td><img src="data:image/png;base64,{{ $barcodeBase64 }}"><br></td>
        <td></td>
    </tr>
    <tr>
        <td>PIECES: {{ $totalPackages }}</td>
        <td>WEIGHT {{ $grossWeight }} Lb</td>
        <td>WEIGHT {{ \App\Helpers\Units::poundsToKilos($grossWeight) }} Kg</td>
    </tr>
</table>
...
<table border="1">
    <tr>
        <td style="font-size:8px;">
            ...
            <?php
                $trackingNumbers = [];
                foreach ($warehouse->packages() as $package) $trackingNumbers[] = $package->tracking_number;
