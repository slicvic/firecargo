...
<table border="0">
    <tr>
        <td width="60%">
            <img width="200" height="50" src="/assets/img/avatar.png"><br>
            ...
            {{ ($country = $company->country) ? strtoupper($country->name) : '' }}<br>
            ...
            {{ ($country = $consignee->country) ? strtoupper($country->name) : '' }}<br>
        </td>
    ...
    <tr>
        <td width="70%"><table border="1">
                ...
                @foreach ($packages as $package)
                    <tr>
                        <td>{{ ($type = $package->type) ? strtoupper($type->name) : '' }}</td>
        ...
        <td width="30%">
            ...
            <table id="metrics" border="1">
                ...
                <tr>
                    ...
                    <td><small>KILOS</small><br><span style="font-size:16px;">{{ \App\Helpers\Units::poundsToKilos($grossWeight, 0) }}</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><small>CHARGE WEIGHT</small><br><span style="font-size:16px;">{{ \App\Helpers\Units::poundsToKilos($chargeWeight, 0) }} <small>Kg</small></span></td>
                </tr>
            </table>
        </td>
    </tr>
