            ...
            <div class="ibox">
               <div class="ibox-content text-center">
                    ...
                    <div id="logoContainer" class="m-b-sm">
                        <img class="img-circle" src="{{ $company->getLogoUrl('md') ?: $company->getDefaultLogoUrl() }}" style="width:100px;height:100px">
                    </div>
                    <div class="text-center">
                        <button style="margin-top:4px;" type="button" id="btnChangeLogo" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i> Change Logo</button>
