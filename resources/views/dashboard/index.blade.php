                ...
                <div class="col-md-4">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <ul class="category-list">
                                <li><a href="/packages?status=unprocessed"> <i class="fa fa-circle text-danger"></i> Unprocessed ({{ $totals['packages']['unprocessed'] }})</a></li>
                                <li><a href="/packages?status=hold"> <i class="fa fa-circle text-warning"></i> On Hold ({{ $totals['packages']['hold'] }})</a></li>
                                <li><a href="/packages?status=shipped"> <i class="fa fa-circle text-navy"></i> Shipped ({{ $totals['packages']['shipped'] }})</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
